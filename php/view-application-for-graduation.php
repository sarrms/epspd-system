...
<head>
	...
	<title>result-of-application-for-graduation.pdf</title>
...
<body>
	<div class="all-header">
		<span>result-of-application-for-graduation.pdf</span>
		<span id="print-all-btn" title="Print all"><i class="fas fa-print"></i></span>
	</div>
	<div class="main">
		<div id="main-body" class="main-body">
			<div id="main-paper" class="main-paper">
				<!-- LIST OF QUALIFIED AND WITH QUESTION MARK STUDENTS IN APPLICATION FOR GRADUATION REPORT -->
				<div>
					<span>Result of Application for Graduation</span>
				...
				<!-- SUMMARY REPORT OF APPLICATION FOR GRADUATION -->
				<table class="view-footer">
					...
					<tr>
						...
						<td>
							<span><?php echo $highestRow - 2; ?></span>
						</td>
					</tr>
				</table>
				<!-- LIST OF STUDENT REMOVED FROM LIST IN APPLICATION FOR GRAUATION -->
