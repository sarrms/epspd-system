<link rel="stylesheet" href="css/paper-list-graduates.css">
...
if (isset($_COOKIE["application-for-graduation-file"])) {
	...
	<script>
		document.getElementById("view-form-btn").addEventListener("click", function() {
			window.open("view.php?view=list-of-graduates", "_blank", "toolbar, location=no");
		});
	</script>
	<script>
...
<div id="main-paper">
	...
	if (isset($_COOKIE["application-for-graduation-file"])) {
		if (isset($_POST["rel"])) {
			include "paper-list-graduates.php";
		}
		else {
			include "php/paper-list-graduates.php";
		}
	}
	?>
</div>
<script>
	document.title = "List of Graduates - Evaluation Process to Diploma System";
</script>
<script>
	...
	document.getElementById("list-graduates").classList.add("active");
